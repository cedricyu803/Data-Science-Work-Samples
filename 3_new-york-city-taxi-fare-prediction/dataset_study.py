...
train_df[['fare_amount']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'skyblue')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Fare amount in USD')
ax.set_title(None)
...
sns.boxplot(x = train_df['fare_amount'][(train_df['fare_amount'] < 2000) & (train_df['fare_amount'] > 2.49)], color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Fare amount in USD')
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
...
train_df['fare_amount'][(train_df['fare_amount'] < 2000) & (train_df['fare_amount'] > 2.49)].hist(bins = 100, grid = False, ax = plt.gca(), color = 'skyblue')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Fare amount in USD')
ax.set_title(None)
...
train_df_passenger_count00 = train_df[['passenger_count']].groupby(['passenger_count']).size()

fig = plt.figure('passenger_count_hist', dpi = 150)
sns.barplot(x = train_df_passenger_count00.index, y = train_df_passenger_count00.values, color = 'skyblue')
plt.yscale('log')
ax = plt.gca()
...
train_df_passenger_count0 = train_df[['passenger_count']][(train_df['passenger_count'] > 0) & (train_df['passenger_count'] < 10)].groupby(['passenger_count']).size()

fig = plt.figure('passenger_count_g0_leq9_hist', dpi = 150)
sns.barplot(x = train_df_passenger_count0.index, y = train_df_passenger_count0.values, color = 'skyblue')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Number of passengers')
ax.set_ylabel(None)
...
train_df_passenger_count = train_df[['passenger_count']][(train_df['passenger_count'] > 0) & (train_df['passenger_count'] < 7)].groupby(['passenger_count']).size()

fig = plt.figure('passenger_count_g0_leq6_hist', dpi = 150)
sns.barplot(x = train_df_passenger_count.index, y = train_df_passenger_count.values, color = 'skyblue')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Number of passengers')
ax.set_ylabel(None)
...
# test set
test_df_passenger_count00 = test_df[['passenger_count']].groupby(['passenger_count']).size()

fig = plt.figure('passenger_count_hist', dpi = 150)
sns.barplot(x = test_df_passenger_count00.index, y = test_df_passenger_count00.values, color = 'tomato')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Number of passengers')
ax.set_ylabel(None)
...
sns.barplot(x = train_df_passenger_count.index, y = train_df_passenger_count.values, color = 'skyblue', ax=axes[0])
sns.barplot(x = test_df_passenger_count00.index, y = test_df_passenger_count00.values, color = 'tomato', ax=axes[1])
...
"""
train_df_passenger_fare = train_df[['passenger_count', 'fare_amount']].groupby(['passenger_count']).agg(np.nanmean).reset_index()

fig = plt.figure('fare_by_passenger_bar', dpi = 150)
sns.barplot(x = train_df_passenger_fare['passenger_count'], y = train_df_passenger_fare['fare_amount'], color = 'skyblue')
# plt.yscale('log')
ax = plt.gca()
...
sns.barplot(x = train_df_passenger_fare['passenger_count'][(train_df_passenger_fare['passenger_count'] > 0) & (train_df_passenger_fare['passenger_count'] < 7)], y = train_df_passenger_fare['fare_amount'][train_df_passenger_fare['passenger_count'] < 10], color = 'skyblue')
# plt.yscale('log')
ax = plt.gca()
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
sns.barplot(x = train_df_year_count.index, y = train_df_year_count.values, color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Year')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
fig = plt.figure('year_count_training', dpi = 150)
sns.barplot(x = test_df_year_count.index, y = test_df_year_count.values, color = 'tomato')
ax = plt.gca()
ax.set_xlabel('Year')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
figure, axes = plt.subplots(1, 2, dpi = 150)
sns.barplot(x = train_df_year_count1.index, y = train_df_year_count1.values, color = 'skyblue', ax = axes[0])
sns.barplot(x = test_df_year_count.index, y = test_df_year_count.values, color = 'tomato', ax = axes[1])
ax = axes[0]
ax.set_xlabel('Year')
ax.set_ylabel(None)
# ax.set_yticks([])
...
"""
train_df_yearly_fare = train_df[['year', 'fare_amount']].groupby(['year']).agg(np.nanmean).reset_index()
...
sns.barplot(x = train_df_yearly_fare['year'], y = train_df_yearly_fare['fare_amount'], color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Year')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
sns.barplot(x = train_df_month_count.index, y = train_df_month_count.values, color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Month')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
"""
train_df_monthly_fare = train_df[['month', 'fare_amount']].groupby(['month']).agg(np.nanmean).reset_index()

fig = plt.figure('month_mean_fare_training', dpi = 150)
sns.barplot(x = train_df_monthly_fare['month'], y = train_df_monthly_fare['fare_amount'], color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Month')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
sns.barplot(x = train_df_weekday_count.index, y = train_df_weekday_count.values, color = 'skyblue')
ax = plt.gca()
...
"""
train_df_weekday_fare = train_df[['weekday', 'fare_amount']].groupby(['weekday']).agg(np.nanmean).reset_index()
train_df_weekday_fare['weekday'] = train_df_weekday_fare['weekday'].replace(dict(zip(range(0, 7), ['Mon', 'Tue', 'Wed', 'Thurs', 'Fri', 'Sat', 'Sun'])))

fig = plt.figure('weekday_mean_fare_training', dpi = 150)
sns.barplot(x = train_df_weekday_fare['weekday'], y = train_df_weekday_fare['fare_amount'], color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Weekday')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
sns.barplot(x = train_df_day_count.index, y = train_df_day_count.values, color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Day')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
train_df_day_fare = train_df[['day', 'fare_amount']].groupby(['day']).agg(np.nanmean).reset_index()

fig = plt.figure('day_mean_fare_training', dpi = 150)
sns.barplot(x = train_df_day_fare['day'], y = train_df_day_fare['fare_amount'], color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Day')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
fig = plt.figure('day_count_training', dpi = 150)
sns.barplot(x = train_df_hour_count.index, y = train_df_hour_count.values, color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Hour')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
train_df_hour_fare = train_df[['hour', 'fare_amount']].groupby(['hour']).agg(np.nanmean).reset_index()

fig = plt.figure('hour_mean_fare_training', dpi = 150)
sns.barplot(x = train_df_hour_fare['hour'], y = train_df_hour_fare['fare_amount'], color = 'skyblue')
ax = plt.gca()
ax.set_xlabel('Hour')
# for i, p in enumerate(ax.patches):
#     height = p.get_height()
...
fig = plt.figure('pickup_latitude_training', dpi = 150)
train_df[['pickup_latitude']].hist(bins = 50, grid = False, ax = plt.gca(), color = 'skyblue', label = 'training set')
test_df[['pickup_latitude']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'tomato', label = 'test set')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Pickup latitude')
ax.set_title(None)
...
len(train_df['pickup_latitude'][((train_df['pickup_latitude'] < 40.40) | (train_df['pickup_latitude'] > 41.06)) & (train_df['pickup_latitude'] != 0.0)])
# 68038
...
long_max = -73.33
long_min = -75.00
len(train_df['pickup_longitude'][((train_df['pickup_longitude'] > -73.33) | (train_df['pickup_longitude'] < -75.00)) & (train_df['pickup_longitude'] != 0.0)])
# 64197
len(train_df['pickup_longitude'][(train_df['pickup_longitude'] == 0.0)])
# 1051666

fig = plt.figure('pickup_longitude_training', dpi = 150)
train_df[['pickup_longitude']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'skyblue', label = 'training set')
test_df[['pickup_longitude']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'tomato', label = 'test set')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Pickup longitude')
ax.set_title(None)
...
fig = plt.figure('dropoff_latitude_training', dpi = 150)
train_df[['dropoff_latitude']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'skyblue', label = 'training set')
test_df[['dropoff_latitude']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'tomato', label = 'test set')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Dropoff latitude')
ax.set_title(None)
...
len(train_df['dropoff_latitude'][((train_df['dropoff_latitude'] < 40.40) | (train_df['dropoff_latitude'] > 41.06)) & (train_df['dropoff_latitude'] != 0.0)])
# 66259
...
train_dfm = train_df[['pickup_latitude', 'dropoff_latitude']].melt(var_name = 'dataset').replace({'pickup_latitude': 'Pickup', 'dropoff_latitude': 'Dropoff'})
...
long_max = -73.33
long_min = -75.00
len(train_df['dropoff_longitude'][((train_df['dropoff_longitude'] > -73.33) | (train_df['dropoff_longitude'] < -75.00)) & (train_df['dropoff_longitude'] != 0.0)])
# 58303
len(train_df['dropoff_longitude'][(train_df['dropoff_longitude'] == 0.0)])
# 1048483

fig = plt.figure('dropoff_longitude', dpi = 150)
train_df[['dropoff_longitude']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'skyblue', label = 'training set')
test_df[['dropoff_longitude']].hist(bins = 100, grid = False, ax = plt.gca(), color = 'tomato', label = 'test set')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Dropoff longitude')
ax.set_title(None)
...
train_dfm = train_df[['pickup_longitude', 'dropoff_longitude']].melt(var_name = 'dataset').replace({'pickup_longitude': 'Pickup', 'dropoff_longitude': 'Dropoff'})
...
len(test_df['pickup_latitude'][((test_df['pickup_latitude'] < 40.40) | (test_df['pickup_latitude'] > 41.06)) & (test_df['pickup_latitude'] != 0.0)])
# 9
...
long_max = -73.33
long_min = -75.00
len(test_df['pickup_longitude'][((test_df['pickup_longitude'] > -73.33) | (test_df['pickup_longitude'] < -75.00)) & (test_df['pickup_longitude'] != 0.0)])
# 8
...
train_df['long_displacement'] = R_earth * ((train_df['dropoff_longitude'] - train_df['pickup_longitude']) * np.pi / 180) * np.cos( 0.5*(train_df['dropoff_latitude'] + train_df['pickup_latitude']) * np.pi / 180 )
train_df['lat_displacement'] = abs(R_earth * (train_df['dropoff_latitude'] - train_df['pickup_latitude']) * np.pi / 180 )
train_df['euclidean_distance_miles'] = np.sqrt( train_df['long_displacement'] * train_df['long_displacement'] + train_df['lat_displacement'] * train_df['lat_displacement'] )

test_df['long_displacement'] = R_earth * ((test_df['dropoff_longitude'] - test_df['pickup_longitude']) * np.pi / 180) * np.cos( 0.5*(test_df['dropoff_latitude'] + test_df['pickup_latitude']) * np.pi / 180 )
test_df['lat_displacement'] = abs(R_earth * (test_df['dropoff_latitude'] - test_df['pickup_latitude']) * np.pi / 180 )
test_df['euclidean_distance_miles'] = np.sqrt( test_df['long_displacement'] * test_df['long_displacement'] + test_df['lat_displacement'] * test_df['lat_displacement'] )
...
train_df['euclidean_distance_miles'].hist(bins = 100, grid = False, range = (0, 100), ax = plt.gca(), color = 'skyblue', label = 'training set')
test_df['euclidean_distance_miles'].hist(bins = 100, grid = False, range = (0, 100), ax = plt.gca(), color = 'tomato', label = 'test set')
plt.yscale('log')
ax = plt.gca()
...
train_df['direction'] = np.arctan2(train_df['lat_displacement'], train_df['long_displacement'])
...
fig = plt.figure(dpi = 150)
sns.scatterplot(x = train_df['sin_direction'], y = train_df['fare_amount'], color = 'skyblue')
ax = plt.gca()
...
train_df['dropoff_zipcode'] = gaz_zip_county.loc[kdt.query(train_df[['dropoff_latitude', 'dropoff_longitude']].to_numpy(), k=1, return_distance=False).squeeze(), 'GEOID'].values

train_df['dropoff_county'] = gaz_zip_county.loc[kdt.query(train_df[['dropoff_latitude', 'dropoff_longitude']].to_numpy(), k=1, return_distance=False).squeeze(), 'COUNTY'].values

train_df[['pickup_county', 'dropoff_county']] = train_df[['pickup_county', 'dropoff_county']].fillna('not_in_NYC')



train_df_pickup_county = train_df[['pickup_county']].groupby(['pickup_county']).size()

fig = plt.figure('pickup_county', dpi = 150)
sns.barplot(x = train_df_pickup_county.index, y = train_df_pickup_county.values, color = 'skyblue')
plt.yscale('log')
ax = plt.gca()
...
train_df_dropoff_county = train_df[['dropoff_county']].groupby(['dropoff_county']).size()

fig = plt.figure('pickup_county', dpi = 150)
sns.barplot(x = train_df_dropoff_county.index, y = train_df_dropoff_county.values, color = 'skyblue')
plt.yscale('log')
ax = plt.gca()
...
"""
train_df['dropoff_pickup_same_county'] = (train_df['dropoff_county'] == train_df['pickup_county'])


fig = plt.figure('same_county', dpi = 150)
sns.countplot(train_df['dropoff_pickup_same_county'], orient = 'h', color = 'skyblue')
ax = plt.gca()
...
sns.heatmap(cor2,mask= mask,square=True, annot = True, annot_kws = {'size': 'xx-small'})
ax = plt.gca()
...
y_test_predict = pd.read_csv('predictions/2021-09-09_3/y_test_predict_LGBMreg.csv')


fig = plt.figure('fare_amount_training_hist', dpi = 200)
y_train_valid[y_train_valid['fare_amount'] < 80]['fare_amount'].hist(bins = 100, grid = False, ax = plt.gca(), color = 'skyblue', label = 'training set')
y_test_predict[y_test_predict['fare_amount'] < 80]['fare_amount'].hist(bins = 100, grid = False, ax = plt.gca(), color = 'tomato', label = 'test set (prediction)')
plt.yscale('log')
ax = plt.gca()
ax.set_xlabel('Fare amount in USD')
ax.set_title(None)
