...
class HyperModel(HyperModel):
    ...
    def build(self, hp):
        ...
        num_dense_hidden = hp.Int(
            'num_dense_hidden', min_value=1, max_value=10, step=1)
...
X_train_encoded4 = pd.read_csv(
    'engineered_datasets/2021-09-06_5/X_train_encoded4.csv', index_col=[0])
X_valid_encoded4 = pd.read_csv(
    'engineered_datasets/2021-09-06_5/X_valid_encoded4.csv', index_col=[0])
X_train_encoded4_scaled = pd.read_csv(
    'engineered_datasets/2021-09-06_5/X_train_encoded4_scaled.csv', index_col=[0])
X_valid_encoded4_scaled = pd.read_csv(
    'engineered_datasets/2021-09-06_5/X_valid_encoded4_scaled.csv', index_col=[0])

y_train_log = pd.read_csv(
    'engineered_datasets/2021-09-06_5/y_train_log.csv', index_col=[0])
y_valid_log = pd.read_csv(
    'engineered_datasets/2021-09-06_5/y_valid_log.csv', index_col=[0])
...
my_model = keras.Sequential([
    layers.Dense(units=2048, input_shape=input_shape,
                 activation='tanh'),  # use tanh
...
X_test_encoded4 = pd.read_csv(
    'engineered_datasets/2021-09-06_5/X_test_encoded4.csv', index_col=[0])
X_test_encoded4_scaled = pd.read_csv(
    'engineered_datasets/2021-09-06_5/X_test_encoded4_scaled.csv', index_col=[0])
...
y_test_predict = pd.Series(
    pred.squeeze(), index=X_test_id, name='trip_duration')
# all positive
